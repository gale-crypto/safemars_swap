    ...
    const fetch = async () => {
      ...
      if (error) {
        ...
        const formatted = tokenAddresses.reduce((accum: { [address: string]: TokenData }, address) => {
          ...
          const name = address.toLowerCase() === "0xe81ca6eb09bd7d28ebc6362cd531d44528dcbf0d" ? "XAU" : (current ? current.name : "")
          const symbol = address.toLowerCase() === "0xe81ca6eb09bd7d28ebc6362cd531d44528dcbf0d" ? "XAU" : (current ? current.symbol : "")
