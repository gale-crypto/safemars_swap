      ...
      >
        <BunnyWrapper>
          <HeadingSection scale="df" color="#000" mb="24px" style={{ paddingBottom: '0px' }}>
            ...
            <InnerWrapper >
              {t("A. With defipower.com right now we have our Safemars token, an on chain swap function, Staking and Xfortune")}
            </InnerWrapper>
          </HeadingSection>
          <HeadingSection scale="df" color="#000" mb="24px" >
            <InnerWrapper >
              {t("Q. As our Safemars token presale has successfully rolled out how do I claim my DEP tokens?")}
            </InnerWrapper>
            <InnerWrapper >
          ...
          <HeadingSection scale="df" color="#000" mb="24px" >
            <InnerWrapper >
              {t("Q. Is there any risk involved in Defi and defipower.com?")}
            </InnerWrapper>
            <InnerWrapper >
          ...
          <HeadingSection scale="df" color="#000" mb="24px" >
            <InnerWrapper >
              {t("Q. What is the slippage average on transaction that include the DEP token?")}
            </InnerWrapper>
            <InnerWrapper >
              {t("A. The slippage tolerance for the DEP token as a single swap or liquidity pair is 12%")}
            </InnerWrapper>
          </HeadingSection>
          <HeadingSection scale="df" color="#000" mb="24px" >
            <InnerWrapper >
            ...
            <InnerWrapper >
              {t("A. For technical support please contact support (@NomadzMATT) within our official telegram or send an email to our support email address - support@defipower.com")}
            </InnerWrapper>
          </HeadingSection>
        </BunnyWrapper>
      </Flex>
