      ...
      >
        <Flex flex="1" flexDirection="column" style={{ paddingLeft: '10px' }}>
          ...
          <Heading scale="df" color="#fff" mb="24px" style={{ lineHeight: '30px' }}>
            {t("Our liquidity pools are live - we are excited to present Staking, stake LP tokens to earn great APR! Staking also supports the zap function so you can add liquidity easily.")}
          </Heading>
          <Heading scale="xl" color="#fff" mb="24px" mt="24px">
            {t("THE XFUZION ADVANTAGE:")}
          </Heading>
