...
import logoImage from '../../../../public/images/safemars.png'
...
const Hero = () => {
  ...
  return (
    <>
      <BgWrapper>
        <InnerWrapper>{theme.isDark ? <SlideSvgDark width="100%" /> : <SlideSvgDark width="100%" />}</InnerWrapper>
      </BgWrapper>
      <Flex
        position="relative"
      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading scale="xxl" color="secondary" mb="24px">
            {t("Safemars become world's best community.")}
          </Heading>
        ...
        >
          <BunnyWrapper>
            <Image src={logoImage} priority placeholder="blur" alt={t('Lunar bunny')} />
          </BunnyWrapper>
          <StarsWrapper>
