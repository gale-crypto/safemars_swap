...
export const earnSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t('Safemars makes it easy to make your crypto work for you.'),
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: t('Explore'),
  ...
  secondaryButton: {
    to: 'https://docs.defipower.com/products/yield-farming',
    text: t('Learn'),
    external: true,
  },
  images: {
...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t(
    'CAKE token is at the heart of the Safemars ecosystem. Buy it, win it, farm it, spend it, stake it... heck, you can even vote with it!',
  ),
  reverse: false,
  primaryButton: {
  ...
  secondaryButton: {
    to: 'https://docs.defipower.com/tokenomics/cake',
    text: t('Learn'),
    external: true,
  },
