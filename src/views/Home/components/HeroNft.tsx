      ...
      >
        ...
        <Flex flex="1" flexDirection="column" style={{ paddingLeft: '10px' }}>
          ...
          <Heading scale="df" color="#fff" mb="24px" style={{ lineHeight: '30px' }}>
            {t("Our NFTs are more than collectibles — they're a bold statement of the Safemars between art and finance. The referrals on the NFTs is 4% referrals for referring others to mint NFTs. There are many other benefits, that can be found in our whitepaper")}
          </Heading>
        </Flex>
      </Flex>
      </div>
