...
> = ({ address, size = '24px', ...rest }) => {
  const src = useMemo(() => {
    ...
    if (checksummedAddress) {
      // return `https://assets-cdn.trustwallet.com/blockchains/smartchain/assets/${checksummedAddress}/safemars.png`
      return `/images/11451/tokens/${checksummedAddress}.png`
    }
    return null
  }, [address])
