    ...
    <StyledStepCard width={['280px', '330px', '380px']}>
      <StepCardInner height="auto">
        ...
        <AllocationGrid>
          ...
          <AllocationMatch color="#BDC2C4" text={t('Staking')} />
          <Text textAlign="right" bold>
            20%
          </Text>
        </AllocationGrid>
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in DEP per ticket.'),
    },
    {
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t('100% of the DEP paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed DEP for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'An average total of 35,000 DEP from the treasury is added to Xfortune rounds over the course of a week. This DEP is of course also included in rollovers! Read more in our guide to ',
                )}
