  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover Safemars, the leading DEX on PULSE Chain."
        />
        ...
        <meta name="twitter:title" content="Safemars - A next evolution DeFi exchange on PULSE Chain" />
